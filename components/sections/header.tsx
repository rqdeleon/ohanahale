...
export default function Header(){
  ...
  return(
    <header className="header-area">
        {/* Hero Section */}
        <MainNav />
        <section className="bg-cover bg-center h-screen flex items-center justify-center overflow-hidden relative pt-20" style={{backgroundImage:'url(https://res.cloudinary.com/dh3h0lhyh/image/upload/v1718677157/ohana_hale/wh4lofqdjaiygsebhjla.jpg)'}}>
            <div className="z-10 text-center text-white px-6">
                <h1 className="text-4xl md:text-6xl font-bold">Experience Tagaytay in luxury accommodation</h1>
                <p className="mt-4 text-lg md:text-xl">Hawaiian-inspired condo Located @ Serin East Condo Across Ayala Malls Serin! </p>
